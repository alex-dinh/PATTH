...
SelfSACTRB = TypeVar("SelfSACTRB", bound="SACTRB")

class SACTRB(OffPolicyAlgorithm):
    """
    Soft Actor-Critic with Transformer Replay Buffer (SACTRB)
    ...
    def train(self, gradient_steps: int, batch_size: int = 64) -> None:
        ...
        for gradient_step in range(gradient_steps):
            ...
            avg_q_current = 0.5 * (current_q_values[0] + current_q_values[1])
